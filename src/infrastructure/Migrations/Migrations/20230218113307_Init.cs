...
namespace Migrations.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_#TempId", x => x.Id);
            //    });

			// commented out because we are now using a standalone Identity Server
            //migrationBuilder.CreateTable(
            //    name: "AspNetRoles",
            //    columns: table => new
            //    {
            ...
            //        CategoryColor = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
